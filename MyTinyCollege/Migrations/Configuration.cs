namespace MyTinyCollege.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyTinyCollege.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(MyTinyCollege.Models.ApplicationDbContext context)
        {
            ...
            {
                new Student {FirstMidName = "Carson", LastName = "Alexander", EnrollmentDate = DateTime.Parse("2015-02-01"), Email = "calexander@tinycollege.com"},
                new Student {FirstMidName = "Alonse", LastName = "Arturo", EnrollmentDate = DateTime.Parse("2015-02-01"), Email = "aaturo@tinycollege.com"},
                new Student {FirstMidName = "John", LastName = "Smith", EnrollmentDate = DateTime.Parse("2015-02-01"), Email = "jsmith@tinycollege.com"},
                new Student {FirstMidName = "fadi", LastName = "faddior", EnrollmentDate = DateTime.Parse("2015-02-01"), Email = "ffaddior@tinycollege.com"},
                new Student {FirstMidName = "Laura", LastName = "Norman", EnrollmentDate = DateTime.Parse("2015-02-01"), Email = "lnorman@tinycollege.com"}
            };
            ...
            foreach(Enrollment e in enrollments)
            {
                var enrollmentInDatabase = context.Enrollments.Where(
                    ...
                    s.course.CourseID == e.CourseID).SingleOrDefualt();
